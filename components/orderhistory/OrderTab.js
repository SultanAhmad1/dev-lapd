                    ...
                    <div className="order-item-div">
                        <div className="lazyload-wrapper " style={{height: "140px"}}>
                            <picture>
                                ...
                                <Image 
                                    alt={order?.order_lines?.[0]?.product_name} 
                                    role="presentation" 
                                    src={`${order?.order_lines?.[0]?.product_image ? IMAGE_URL_Without_Storage+""+ order?.order_lines?.[0]?.product_image?.url: "https://duyt4h9nfnj50.cloudfront.net/sku/07a57b3c6cf4a1643112a8fa13b82531"}`}
