...
export default function ViewCartMobileBtn() 
{
  ...
  return (
    <>
      ...
      {/* <el-dialog>
        <dialog id="dialog" aria-labelledby="dialog-title" className="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-[#eaeaea] backdrop:bg-[#eaeaea]">
          <el-dialog-backdrop className="fixed inset-0 bg-[#eaeaea] transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"></el-dialog-backdrop>
          <div className="bg-[#eaeaea] px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button type="button" command="close" commandfor="dialog" className="mt-3 inline-flex w-full justify-center rounded-md bg-[#eaeaea] px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-[#eaeaea] sm:mt-0 sm:w-auto"> 
              <svg
                  width="24"
                  height="24"
                  fill="none"
          ...
          <div tabindex="0" className="flex h-auto items-end justify-center p-1 text-center focus:outline-none sm:items-center sm:p-0">
            <el-dialog-panel className="relative transform overflow-hidden rounded-lg bg-[#eaeaea] text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-full sm:max-w-lg data-closed:sm:translate-y-0 data-closed:sm:scale-95">
              <div className="bg-[#eaeaea] px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <CheckoutDisplay />
              </div>
            </el-dialog-panel>
          </div>
