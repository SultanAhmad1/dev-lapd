...
export default function Header() 
{
    ...
    const{setIscartbtnclicked, setIsdeliverybtnclicked} = useContext(HomeContext)
    return (
        <>
            <header>
                <div className="header">
                    <div className="header-div">
                        ...
                        <a href="/">
                            <Image  src="../gallery/uber-eat.svg" width={146} height={24} className="brand-logo" alt='brand-logo'/>
                        </a>
                        <div className="spacer _40"></div>
                        {
                            // (router.query !== 'place-order' || router.query !== 'payment')&&
