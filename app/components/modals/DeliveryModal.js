...
{
    const {postcode,street1, street2,isdeliverychangedbtnclicked, isdeliverybtnclicked, setIsdeliverybtnclicked, setIsdeliverychangedbtnclicked} = useContext(HomeContext)
                    ...
                    <div className="modal-delivery-details-level-one-div-dialog-header">
                        ...
                        <button className="delivery-modal-close-button">
                            {isdeliverychangedbtnclicked ? (
                                <div className="delivery-modal-close-button-svg-div testing2 deliverychange" onClick={() => setIsdeliverychangedbtnclicked(!isdeliverychangedbtnclicked)}>
                                ...
                                <div className="delivery-modal-close-button-svg-div testing1 delivery" onClick={() => setIsdeliverybtnclicked(false) }>
                                        <svg
                                        width="24px"
                                        height="24px"
                                        fill="none"
