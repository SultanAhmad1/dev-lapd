...
{
    const {storeName,navigationcategories, navmobileindex, setSelectedcategoryid, setSelecteditemid, setNavmobileindex} = useContext(HomeContext)
        ...
        <>
            ...
            <div className="content">
                <div className="content-div-level-one">
                    ...
                    <MobileTopBar handleCategoryClick={handleCategoryClick} isscrolled={isscrolled} scrollPosition={scrollPosition}/>
