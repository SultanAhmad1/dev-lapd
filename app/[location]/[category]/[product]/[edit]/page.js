                    ...
                    <div className="single-item-qty-div">
                      <div className="qty-selector">
                        <div className="qty-selector-div">
                          <select className="qty-select" value={quantity} onChange={handleQuantity}>
      ...
      <>
        {
          ...
          {
            return(
              (modalmodifier?.id === selectedModifierId) && modalmodifier?.modifier_secondary_items?.map((secondaryItem, index) =>
              {
                return(
