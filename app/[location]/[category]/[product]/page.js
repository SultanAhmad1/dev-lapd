...
function productDetails({ params }) {
  ...
  const handleRadioInput = useCallback(
    (modifierId, itemId, itemName, secondaryItemModifierCounter) => {
  ...
  const handleCheckInput = useCallback(
    (modifierId, itemId, secondaryItemModifierCounter) => {
  ...
  const handleModalRadioInput = useCallback(
    (modifierId, itemId, secondaryModifierId, secondaryItemId) => {
  ...
  const handleModalCheckInput = useCallback(
    (modifierId, itemId, secondaryModifierId, secondaryItemId) => {
      ...
      for (const countModifier of updateItem.modifier_group) {
        if (modifierId === countModifier?.id) {
          if (
            parseInt(countModifier?.modifier_secondary_items.length) >
            parseInt(0)
          ) {
  ...
  const handleModalIncrement = useCallback(
    (modifierId, itemId, secondModifierId, secondItemId) => {
      const updateItem = {
        ...singleitem,
        modifier_group: singleitem?.modifier_group?.map((modifier) => {
          if (modifierId === modifier?.id) {
                              ...
                              return {
                                ...
                                valid_class:
                                  parseInt(secondItemModifier.min_permitted) >
                                    parseInt(0) &&
                                  secondItemModifier.valid_class ===
                                    "error_check"
                                    ? "success_check"
                                    : "success_check",
                                secondary_items_modifier_items:
  ...
  const handleModalDecrement = useCallback(
    (modifierId, itemId, secondModifierId, secondItemId) => {
      let totalAmount = selectedModifierItemPrice;
      for (const updateItemModifier of singleitem.modifier_group) {
        if (updateItemModifier?.id === modifierId) {
  ...
  const handleAddtoCart = useCallback(() => {
    ...
    console.log("Handle add to cart method clicked:");
    if (singleitem) {
  ...
  }, [singleitem, cartdata, iscartbtnclicked]);
  ...
  const handleMobileModifierToggle = useCallback(
    (modifierId) => {
  ...
  const handleModalModifierToggle = useCallback(
    (modifierId, itemId, secondModifierId) => {
    ...
    <>
      ...
      <div>
        <div className="mobile-view">
          <MobileSingleItem
            handleMScroll={handleMScroll}
            singleitem={singleitem}
            quantity={quantity}
            itemprice={itemprice}
            handleCheckInput={handleCheckInput}
            handleMobileModifierToggle={handleMobileModifierToggle}
            handleDecrement={handleDecrement}
            handleIncrement={handleIncrement}
            handleMobileQuantityDecrement={handleMobileQuantityDecrement}
            handleMobileQuantityIncrement={handleMobileQuantityIncrement}
