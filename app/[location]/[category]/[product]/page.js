...
function productDetails({params}) 
{
    ...
    const filterItem = async () => {
        try 
        {
            ...
            const updateModifier = getItemFromCategory?.modifier_group?.map((modifier) =>
            {
                if(modifier?.select_single_option === 1 && (modifier?.min_permitted === 1 && modifier?.max_permitted === 1))
                {
                    const modifier_secondary_items = modifier?.modifier_secondary_items?.map((modifieritem) =>
                    {
                        if(parseInt(modifieritem?.secondary_item_modifiers.length) > parseInt(0))
                        {
                            ...
                            {
                                if(secondItemModifier?.select_single_option === 1 && (secondItemModifier?.min_permitted === 1 && secondItemModifier?.max_permitted === 1))
                                {
                                ...
                                else if(secondItemModifier?.select_single_option === 1 && (secondItemModifier?.min_permitted === 0 && secondItemModifier?.max_permitted >= 1))
                                {
                                    const updateSecondaryItemModifierItem = secondItemModifier?.secondary_items_modifier_items?.map((secondItemModiItem) =>
                                    {
                                        return{
                ...
                else if(modifier?.select_single_option === 1 && (modifier?.min_permitted === 0 && modifier?.max_permitted >= 1)) {
                                ...
                                secondary_item_modifiers: seconditems?.secondary_item_modifiers?.map((secondaryModifier) =>
                                {
                                    return{
                                        ...
                                        secondary_items_modifier_items: secondaryModifier?.secondary_items_modifier_items?.map((secondaryItem) =>
                                        {
                                            ...
                                            else if(secondaryModifier?.select_single_option === 1 && (secondaryModifier?.min_permitted === 0 && secondaryModifier?.max_permitted >= 1))
                                            {
                                                return{
                                                    ...secondaryItem,
                                                    activeClass: "mche",
    ...
    const handleCheckInput = (modifierId, itemId, secondaryItemModifierCounter) =>
    {
    ...
    const handleModalRadioInput = (modifierId, itemId, secondaryModifierId, secondaryItemId) =>
    {
                        ...
                        for(const secondaryModifier of updateItemModifierItem?.secondary_item_modifiers)
                        {
                            if(secondaryModifierId === secondaryModifier?.id)
                            {
                                for(const secondaryItem of secondaryModifier?.secondary_items_modifier_items)
                                {
                                    ...
                                    {
                                        const newTotalMinus = parseFloat(totalAmount) - parseFloat(secondaryItem?.price_info)
                                        totalAmount = newTotalMinus
                                    }
                                }
                            }
                                ...
                                return{
                                    ...
                                    secondary_item_modifiers: item?.secondary_item_modifiers?.map((secondaryModifier) =>
                                    {
                                        if(secondaryModifierId === secondaryModifier?.id)
                                        {
                                            return{
                                                ...secondaryModifier,
                                                valid_class: (parseInt(secondaryModifier.min_permitted) > parseInt(0) && secondaryModifier.valid_class === "error_check") ? "success_check" : "success_check",
                                                is_modifier_selected: true,
                                                secondary_items_modifier_items: secondaryModifier?.secondary_items_modifier_items?.map((secondaryItem) => {
    ...
    const handleModalCheckInput = (modifierId, itemId, secondaryModifierId, secondaryItemId) =>
    {
                    ...
                    return{
                        ...
                        modifier_secondary_items: modifier?.modifier_secondary_items?.map((secondItem) =>
                        {
                            if(itemId === secondItem.id)
                            {
                                return{
                                    ...secondItem,
                                    secondary_item_modifiers: secondItem?.secondary_item_modifiers?.map((secondModifier) =>
                                    {
                                        if(secondaryModifierId === secondModifier.id)
                                        {
    ...
    const handleModalIncrement = (modifierId, itemId, secondModifierId, secondItemId) =>
    {
        const updateItem = {
            ...singleitem,
            modifier_group: singleitem?.modifier_group?.map((modifier) =>
    ...
    const handleModalDecrement = (modifierId, itemId, secondModifierId, secondItemId) =>
    {
        let totalAmount = selectedModifierItemPrice
        for(const updateItemModifier of singleitem.modifier_group)
        {
                            ...
                            return {
                                ...
                                modifier_secondary_items: modifier?.modifier_secondary_items?.map((secondItem) =>
                                {
                                    if(itemId === secondItem.id)
                                    {
                                        return{
                                            ...secondItem,
                                            secondary_item_modifiers: secondItem?.secondary_item_modifiers?.map((nestedModifier) =>
                                            {
                ...
                if(handleCheckModifierId === modifier?.id)
                {
                    return{
                        ...
                        modifier_secondary_items: modifier?.modifier_secondary_items?.map((seconditems) =>
                        {
                            ...
                            if((parseInt(modifier?.max_permitted) === parseInt(countNumberOfCheck?.length)) && (seconditems?.activeClass !== "mch"))
                            {
                                return{
                                    ...seconditems,
                                    activeClass: "mchw",
                    ...
                    <div className="single-product-level-one-div">
                                    ...
                                    <div className="product-img-div-one-div">
                                        ...
                                        <div className="product-img-div-one-div-nested-div">
                                            <div className="product-img-zoom">
                                                <img alt={singleitem?.title} role="presentation" src={singleitem?.image_url} className="product-img-display" />
                        ...
                        <div className="level-one-div-nested-two">
                            <div className="product-title">
                                ...
                                <span className="product-price-span">{singleitem?.country_price_symbol}{parseFloat(singleitem?.price).toFixed(2)}</span>
                                        ...
                                        <div className="qty-selector">
                                            <div className="qty-selector-div">
                                                <select className="qty-select" onClick={handleQuantity}>
                                                    ...
                                                    <option value="6" className="co">6</option>
                                                    <option value="7" className="co">7</option>
                                                    <option value="8" className="co">8</option>
                                                    <option value="9" className="co">9</option>
                                                    <option value="10" className="co">10</option>
                                                    <option value="11" className="co">11</option>
                                                    <option value="12" className="co">12</option>
                                                    <option value="13" className="co">13</option>
                                                    <option value="14" className="co">14</option>
                                                    <option value="15" className="co">15</option>
                                                    <option value="16" className="co">16</option>
                                                    <option value="17" className="co">17</option>
                                                    <option value="18" className="co">18</option>
                                                    <option value="19" className="co">19</option>
                                                    <option value="20" className="co">20</option>
                                                    <option value="21" className="co">21</option>
                                                    <option value="22" className="co">22</option>
                                                    <option value="23" className="co">23</option>
                                                    <option value="24" className="co">24</option>
                                                    <option value="25" className="co">25</option>
                                                    <option value="26" className="co">26</option>
                                                    <option value="27" className="co">27</option>
                                                    <option value="28" className="co">28</option>
                                                    <option value="29" className="co">29</option>
                                                    <option value="30" className="co">30</option>
                                                    <option value="31" className="co">31</option>
                                                    <option value="32" className="co">32</option>
                                                    <option value="33" className="co">33</option>
                                                    <option value="34" className="co">34</option>
                                                    <option value="35" className="co">35</option>
                                                    <option value="36" className="co">36</option>
                                                    <option value="37" className="co">37</option>
                                                    <option value="38" className="co">38</option>
                                                    <option value="39" className="co">39</option>
                                                    <option value="40" className="co">40</option>
                                                    <option value="41" className="co">41</option>
                                                    <option value="42" className="co">42</option>
                                                    <option value="43" className="co">43</option>
                                                    <option value="44" className="co">44</option>
                                                    <option value="45" className="co">45</option>
                                                    <option value="46" className="co">46</option>
                                                    <option value="47" className="co">47</option>
                                                    <option value="48" className="co">48</option>
                                                    <option value="49" className="co">49</option>
                                                    <option value="50" className="co">50</option>
                                                    <option value="51" className="co">51</option>
                                                    <option value="52" className="co">52</option>
                                                    <option value="53" className="co">53</option>
                                                    <option value="54" className="co">54</option>
                                                    <option value="55" className="co">55</option>
                                                    <option value="56" className="co">56</option>
                                                    <option value="57" className="co">57</option>
                                                    <option value="58" className="co">58</option>
                                                    <option value="59" className="co">59</option>
                                                    <option value="60" className="co">60</option>
                                                    <option value="61" className="co">61</option>
                                                    <option value="62" className="co">62</option>
                                                    <option value="63" className="co">63</option>
                                                    <option value="64" className="co">64</option>
                                                    <option value="65" className="co">65</option>
                                                    <option value="66" className="co">66</option>
                                                    <option value="67" className="co">67</option>
                                                    <option value="68" className="co">68</option>
                                                    <option value="69" className="co">69</option>
                                                    <option value="70" className="co">70</option>
                                                    <option value="71" className="co">71</option>
                                                    <option value="72" className="co">72</option>
                                                    <option value="73" className="co">73</option>
                                                    <option value="74" className="co">74</option>
                                                    <option value="75" className="co">75</option>
                                                    <option value="76" className="co">76</option>
                                                    <option value="77" className="co">77</option>
                                                    <option value="78" className="co">78</option>
                                                    <option value="79" className="co">79</option>
                                                    <option value="80" className="co">80</option>
                                                    <option value="81" className="co">81</option>
                                                    <option value="82" className="co">82</option>
                                                    <option value="83" className="co">83</option>
                                                    <option value="84" className="co">84</option>
                                                    <option value="85" className="co">85</option>
                                                    <option value="86" className="co">86</option>
                                                    <option value="87" className="co">87</option>
                                                    <option value="88" className="co">88</option>
                                                    <option value="89" className="co">89</option>
                                                    <option value="90" className="co">90</option>
                                                    <option value="91" className="co">91</option>
                                                    <option value="92" className="co">92</option>
                                                    <option value="93" className="co">93</option>
                                                    <option value="94" className="co">94</option>
                                                    <option value="95" className="co">95</option>
                                                    <option value="96" className="co">96</option>
                                                    <option value="97" className="co">97</option>
                                                    <option value="98" className="co">98</option>
                                                    <option value="99" className="co">99</option>
                                                </select>
                                ...
                                <div className="ctascusingle-product">
                                    ...
                                    <div className="akcyczbfsingle-product">
                                        ...
                                        <div className="d5single-product">
                                            <Link className="d6aqbfc4single-product-cross-btn" href="/">
                                                ...
                                                (modifier?.select_single_option === 1 && (modifier?.min_permitted === 1 && modifier?.max_permitted === 1)) ?
                                                    ...
                                                    <li key={index} className={`msection${index}`}>
                                                        <div className="fusingle-productlidiv" >
                                                            ...
                                                            <div className="fwsingle-product" onClick={() => handleMobileModifierToggle(modifier?.id)}>
                                                                ...
                                                                <div className={`g5single-product ${modifier?.is_toggle_active ? "show" : "fade"}`}>
                                                                    
                                                                    {
                                                                        modifier?.modifier_secondary_items?.map((mobileSecondItems, index) =>
                                                                        {
                                                                            return(
                                                                                <>
                                                                                    <div className="alakg6bfsingle-product" key={index} onClick={() => handleRadioInput(modifier?.id,mobileSecondItems?.id, mobileSecondItems?.title, parseInt(mobileSecondItems?.secondary_item_modifiers.length))}>
                                                                                        {
                                                                        ...
                                                                        modifier?.modifier_secondary_items?.map((mobileSecondItems, index) =>
                                                                        {
                                                                            return(
                                                                                mobileSecondItems.activeClass !== "mchw" ?
                                                                                    <div key={index} onClick={() => handleCheckInput(modifier?.id,mobileSecondItems?.id, parseInt(mobileSecondItems?.secondary_item_modifiers.length))}>
                                                                            ...
                                                                            <div key={index}>
                                                                                <div className="alg5bfsingle-product">
                                                                                    <div className="alaqbfsingle-product">
                                                                                        ...
                                                                                        <button className="b9bmalambfc4b1gtgugvgwgxgygzh0single-product-incdec-btn" disabled={(parseInt(modifier?.max_permitted) === parseInt(modifier?.modifier_counter)) ? true : false} onClick={() => handleIncrement(modifier?.id,mobileSecondItems?.id)}>
                                                                                            <div className="ez fj">
                                    ...
                                    <div className="albfglh3single-product">
                                        <div className="akh4gzh5h6bxgtb1h7single-product">
                                            ...
                                            <div className="agbdh8h4albfsingle-product">
                                                <button className="e3bubrdpb9h9h0albfc4affoh6hagzf1hbhcdohdhesingle-dec-product" disabled={quantity > 1 ? false : true} onClick={handleMobileQuantityDecrement}>
                                                ...
                                                <button className="e3bubrdpb9h9h0albfc4affoh6hagzf1hbhcdohdhesingle-inc-product" onClick={handleMobileQuantityIncrement}>
                                                    <svg aria-hidden="true" focusable="false" viewBox="0 0 20 20" className="hfg0ebhgsingle-product-svg">
                                                            ...
                                                            <div className="akb0jjjkjljmmodifier-modal">
                                                                <div>
                                                                    ...
                                                                    <div className="fqs3alaqc5s4ass5c0modifier-modal">
                                                                        ...
                                                                        <div className="e6kae8kbmodifier-modal-name">{secondaryItem?.title}</div>
                                                                    </div>

                                                                    <ul className="g0s6modifier-modal">
                                                                        {
                                                                            secondaryItem?.secondary_item_modifiers?.map((secondItemModifier, index) =>
                                                                            {
                                                                                return(
